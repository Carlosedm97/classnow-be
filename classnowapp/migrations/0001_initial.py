    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('celular', models.IntegerField(max_length=15, verbose_name='Celular')),
                ...
                ('roles', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='roles', to='classnowapp.roles')),
